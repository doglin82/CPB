    ...
    ---------------------------------------------------------- */
       ...
       ---------------------------------------------------------- */
        ...
        protected function outputTitle($title) {
            return  '<i class="vc-element-icon '.$this->settings["icon"].'"></i><h4 class="wpb_element_title">'.__($title, 'js_composer').'</h4>';
        }
...
if(!class_exists('FLV_Container')) {
    abstract class FLV_Container extends FLV_ShortCode {
