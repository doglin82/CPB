        ...
        loadContent:function () {
            $.ajax({
                ...
                context:this
                    ...
                    /*icons*/
					$flv_div=this.$content.find('.flv_icon_change');$flv_div.unwrap();$flv_select=$flv_div.prev();
					...
					/*service icons*/
					$flv_div3=this.$content.find('.flv_ico_service_change');$flv_div3.unwrap();$flv_select3=$flv_div3.prev();
